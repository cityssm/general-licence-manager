...
describe('Admin - Licence Categories', () => {
    ...
    it('Adds a New Licence Category', () => {
        ...
        cy.get(".modal input[name='licenceCategory']").should('contain.value', licenceCategory);
    ...
    describe('Updates an Existing Licence Category', () => {
        ...
        it('Adds an Additional Field', () => {
            ...
            cy.get('.modal #container--licenceCategoryFields').should('contain.text', licenceField);
        });
        ...
        it('Adds an Approval', () => {
            ...
            cy.get('.modal .is-close-modal-button').last().click();
            cy.get('.modal #container--licenceCategoryApprovals').should('contain.text', licenceApproval);
        });
        ...
        it('Adds an Additional Fee', () => {
            ...
            cy.get('.modal .is-close-modal-button').last().click();
            cy.get('.modal #container--licenceCategoryAdditionalFees').should('contain.text', additionalFee);
        });
