...
export const getLicenceFields = (licenceId: number | string, licenceCategoryKey: string, database?: sqlite.Database): recordTypes.LicenceField[] => {
  ...
  const rows: recordTypes.LicenceField[] =
    database.prepare(
