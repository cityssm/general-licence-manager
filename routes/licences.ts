...
router.post(
  '/doAddAdditionalFee',
  permissionHandlers.updatePostHandler,
  handler_doAddAdditionalFee
)

router.post(
  '/doDeleteAdditionalFee',
  permissionHandlers.updatePostHandler,
  handler_doDeleteAdditionalFee
)
...
router.post(
  '/doAddLicenceTransaction',
  permissionHandlers.updatePostHandler,
  handler_doAddLicenceTransaction
)

router.post(
  '/doDeleteLicenceTransaction',
  permissionHandlers.updatePostHandler,
...
router.get('/:licenceId/print', handler_print as RequestHandler)
