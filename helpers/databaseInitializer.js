...
export const initLicencesDB = () => {
    ...
    if (!row) {
        ...
        licencesDB
            .prepare('create table if not exists LicenceCategories (' +
            ...
            .run();
        licencesDB
            .prepare('create table if not exists LicenceCategoryFees (' +
            ...
            .run();
        licencesDB
            .prepare('create table LicenceCategoryAdditionalFees (' +
            ...
            .run();
        licencesDB
            .prepare('create table if not exists LicenceCategoryFields (' +
            ...
            .run();
        licencesDB
            .prepare('create table if not exists LicenceCategoryApprovals (' +
            ...
            .run();
        licencesDB
            .prepare('create table if not exists Licences (' +
            ...
            .run();
        licencesDB
            .prepare('create table if not exists RelatedLicences (' +
            ...
            .run();
        licencesDB
            .prepare('create table if not exists LicenceFields (' +
            ...
            .run();
        licencesDB
            .prepare('create table if not exists LicenceApprovals (' +
            'licenceId integer not null,' +
            ...
            .run();
        licencesDB
            .prepare('create table if not exists LicenceAdditionalFees (' +
            'licenceId integer not null,' +
            ...
            .run();
        licencesDB
            .prepare('create table if not exists LicenceTransactions (' +
            'licenceId integer not null,' +
