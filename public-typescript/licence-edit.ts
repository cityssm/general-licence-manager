...
(() => {
    ...
    editFormElement.addEventListener("submit", (formEvent: SubmitEvent) => {
        ...
        const submitURL =
            urlPrefix + "/licences/" + (isCreate ? "doCreateLicence" : "doUpdateLicence");
    ...
    if (!isCreate && document.querySelector("#panel--relatedLicences")) {
        ...
        const removeRelatedLicence = (clickEvent: Event) => {
            ...
            const relatedLicenceId = (
                (clickEvent.currentTarget as HTMLElement).closest(".panel-block") as HTMLElement
    ...
    const deleteAdditionalFee = (clickEvent: Event) => {
        ...
        const additionalFeeRowElement = (clickEvent.currentTarget as HTMLButtonElement).closest(
            "tr"
        );
    ...
    const openAddAdditionalFeeModal = (clickEvent: Event) => {
        ...
        const submitFunction_addAdditionalFee = (formEvent: Event) => {
            ...
            cityssm.postJSON(
                ...
                (responseJSON: {
                    ...
                    (document.querySelector("#licenceEdit--licenceFee") as HTMLInputElement).value =
        ...
        cityssm.openHtmlModal("additionalFee-add", {
            onshown: (modalElement, closeModalFunction) => {
                ...
                (
                    modalElement.querySelector("#additionalFeeAdd--licenceId") as HTMLInputElement
                ).value = licenceId;
                ...
                const licenceEndDateString = (
                    document.querySelector("#licenceEdit--endDateString") as HTMLInputElement
                ).value;
    ...
    if (!isCreate) {
        ...
        if (addAdditionalFeeButtonElement) {
            optionalAdditionalFees = licenceCategory.licenceCategoryAdditionalFees.filter(
                (additionalFee) => {
        ...
        const deleteAdditionalFeeButtonElements = additionalFeeTableElement.querySelectorAll(
    ...
    const getOutstandingBalance = () => {
        ...
        const outstandingBalance = Math.max(
            Number.parseFloat(licenceFeeString) - Number.parseFloat(transactionAmountTotalString),
            0
        );
    ...
    const deleteLicenceTransaction = (clickEvent: Event) => {
        ...
        const transactionIndex = (clickEvent.currentTarget as HTMLButtonElement).closest("tr")
    ...
    const openAddTransactionModal = (clickEvent: Event) => {
        ...
        const setTransactionAmountFunction = (clickEvent: Event) => {
            ...
            const transactionAmountSpanId = (clickEvent.currentTarget as HTMLElement).dataset
                .spanId;
        ...
        cityssm.openHtmlModal("transaction-add", {
            onshow: (modalElement) => {
                ...
                (
                    modalElement.querySelector("#transactionAdd--licenceId") as HTMLInputElement
                ).value = licenceId;
                ...
                if (includeReplacementFee) {
                    modalElement.querySelector("#transactionAdd--replacementFee").textContent = (
                        document.querySelector("#licenceEdit--replacementFee") as HTMLInputElement
                    ).value;
                } else {
                    modalElement
            ...
            onshown: (modalElement, closeModalFunction) => {
                ...
                const setTransactionAmountButtonElements = modalElement.querySelectorAll(
                    ".is-set-transaction-amount-button"
                );
                ...
                const addTransaction_bankInstitutionNumberElement = modalElement.querySelector(
                    "#transactionAdd--bankInstitutionNumber"
                ) as HTMLInputElement;
                const addTransaction_bankTransitNumberElement = modalElement.querySelector(
                    "#transactionAdd--bankTransitNumber"
                ) as HTMLInputElement;
                    ...
                    modalElement
                        ...
                        .addEventListener("click", (clickEvent) => {
                            ...
                            (
                                ...
                                document.querySelector("#licenceEdit--bankName") as HTMLInputElement
                            ).value;
        ...
        issueLicenceButtonElement.addEventListener("click", (clickEvent) => {
            ...
            if (hasUnsavedChanges) {
                ...
                bulmaJS.confirm({
                    ...
                    message:
                        "Are you sure you want to issue this " + licenceAlias.toLowerCase() + "?",
                    contextualColorName: "info",
                    okButton: {
    ...
    if (!isCreate && renewLicenceButtonElement) {
        const doRenew = () => {
            const url = new URL(
                window.location.protocol + "//" + window.location.host + urlPrefix + "/licences/new"
            );
            ...
            url.searchParams.append(
                "licenseeName",
                (document.querySelector("#licenceEdit--licenseeName") as HTMLInputElement).value
            );
            url.searchParams.append(
                "licenseeBusinessName",
                (document.querySelector("#licenceEdit--licenseeBusinessName") as HTMLInputElement)
                    .value
            );
            url.searchParams.append(
                "licenseeAddress1",
                (document.querySelector("#licenceEdit--licenseeAddress1") as HTMLInputElement).value
            );
            url.searchParams.append(
                "licenseeAddress2",
                (document.querySelector("#licenceEdit--licenseeAddress2") as HTMLInputElement).value
            );
            url.searchParams.append(
                "licenseeCity",
                (document.querySelector("#licenceEdit--licenseeCity") as HTMLInputElement).value
            );
            url.searchParams.append(
                "licenseeProvince",
                (document.querySelector("#licenceEdit--licenseeProvince") as HTMLInputElement).value
            );
            url.searchParams.append(
                "licenseePostalCode",
                (document.querySelector("#licenceEdit--licenseePostalCode") as HTMLInputElement)
                    .value
            );
            ...
            if (bankInstitutionNumberElement) {
                ...
                url.searchParams.append(
                    "bankAccountNumber",
                    (document.querySelector("#licenceEdit--bankAccountNumber") as HTMLInputElement)
                        .value
                );
            }
