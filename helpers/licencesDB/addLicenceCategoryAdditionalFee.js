...
export default function addLicenceCategoryAdditionalFee(licenceCategoryAdditionalFeeForm, sessionUser) {
    ...
    database
        ...
        values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`)
        .run(licenceAdditionalFeeKey, licenceCategoryAdditionalFeeForm.licenceCategoryKey, licenceCategoryAdditionalFeeForm.additionalFee, 'flat', 0, '', 0, sessionUser.userName, rightNowMillis, sessionUser.userName, rightNowMillis);
    database.close();
