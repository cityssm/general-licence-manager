      ...
      (licenceResults: { count: number; licences: recordTypes.Licence[] }) => {
        ...
        for (const licenceObject of licenceList) {
          ...
          if (licenceObject.licenseeBusinessName.trim() !== '') {
            licenseeHTML =
              cityssm.escapeHTML(licenceObject.licenseeBusinessName) +
              '<br />' +
          ...
          for (const licenceField of licenceObject.licenceFields) {
            if (
              ...
              fieldsHTML +=
                cityssm.escapeHTML(licenceField.licenceField) +
                ': ' +
                cityssm.escapeHTML(licenceField.licenceFieldValue) +
                '<br />'
            }
          }
          ...
          trElement.innerHTML =
            ...
            urlPrefix +
            '/licences/' +
            licenceObject.licenceId.toString() +
            '">' +
            ...
            '</td>' +
            ('<td>' +
              '<span class="is-nowrap has-tooltip-right" data-tooltip="Start Date" aria-label="Start Date"><i class="fas fa-fw fa-play" aria-hidden="true"></i> ' +
              licenceObject.startDateString +
              '</span><br />' +
              '<span class="is-nowrap has-tooltip-right" data-tooltip="End Date" aria-label="End Date"><i class="fas fa-fw fa-stop" aria-hidden="true"></i> ' +
