...
export function getLicenceLengthEndDateString(licence) {
    ...
    if (licenceCategory.licenceLengthYears > 0) {
        ...
        licenceLengthEndDateString = `${licenceCategory.licenceLengthYears} year${licenceCategory.licenceLengthYears === 1 ? '' : 's'}`;
    }
    if (licenceCategory.licenceLengthMonths > 0) {
        ...
        licenceLengthEndDateString += `${(licenceLengthEndDateString === '' ? '' : ', ') +
            licenceCategory.licenceLengthMonths} month${licenceCategory.licenceLengthMonths === 1 ? '' : 's'}`;
    }
    if (licenceCategory.licenceLengthDays > 0) {
        ...
        licenceLengthEndDateString += `${(licenceLengthEndDateString === '' ? '' : ', ') +
            licenceCategory.licenceLengthDays} day${licenceCategory.licenceLengthDays === 1 ? '' : 's'}`;
    }
