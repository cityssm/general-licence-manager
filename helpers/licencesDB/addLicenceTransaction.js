...
export const addLicenceTransaction = (licenceTransactionForm, requestSession) => {
    ...
    const transactionDate = licenceTransactionForm.transactionDateString && licenceTransactionForm.transactionDateString !== ""
    ...
    database
        ...
        " values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)")
        .run(licenceTransactionForm.licenceId, transactionIndex, transactionDate, licenceTransactionForm.transactionDateString && licenceTransactionForm.transactionDateString !== ""
        ? 0
        : dateTimeFunctions.dateToTimeInteger(rightNow), (licenceTransactionForm.includeInBatch && licenceTransactionForm.includeInBatch !== ""
        ? transactionDate
